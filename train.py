...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default="/root/yolov5/runs/train/exp8/weights/best.pt", help="/root/yolov5/runs/train/exp5/weights/best.pt")
    parser.add_argument("--cfg", type=str, default="/root/yolov5/models/yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default="trash.yaml", help="/root/yolov5/trash.yaml")
